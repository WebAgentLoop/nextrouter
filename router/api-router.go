...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/pricing", middleware.HeaderNavModulePublicOrUserAuth("pricing"), controller.GetPricing)
		apiRouter.GET("/pricing/documentation", middleware.HeaderNavModulePublicOrUserAuth("pricing"), controller.GetModelDocumentation)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/agent/settings", controller.GetAgentSetting)
		...
		modelsRoute.Use(middleware.AdminAuth())
		{
			...
			modelsRoute.GET("/:id/translations", controller.ListModelTranslations)
			modelsRoute.POST("/:id/translations/generate", middleware.CriticalRateLimit(), controller.GenerateModelTranslations)
			modelsRoute.PUT("/:id/translations/:locale", controller.UpdateModelTranslation)
			modelsRoute.DELETE("/:id/translations/:locale", controller.DeleteModelTranslation)
