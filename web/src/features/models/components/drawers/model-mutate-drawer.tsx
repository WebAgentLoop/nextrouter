  ...
  const save = useMutation({
    ...
    mutationFn: async (values: ModelFormValues) => {
      if (!isModelDocumentationWithinLimit(values.documentation || '')) {
        ...
        throw new Error(t('Documentation must not exceed 32 KiB.'))
      }
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Combobox
                                options={MODEL_CONTENT_LANGUAGES.map(
                                  (language) => ({
                                    value: language.code,
                    ...
                    <SideDrawerSection>
                      ...
                      <FormField
                        ...
                        render={({ field }) => {
                          ...
                          const isOverLimit =
                            byteLength > MAX_MODEL_DOCUMENTATION_BYTES
