...
// Mirrors constant.ChannelBaseURLs in the backend. An empty Base URL for one
// of these channel types resolves to the corresponding address at runtime.
const CHANNEL_DEFAULT_BASE_URLS: Record<number, string> = {
